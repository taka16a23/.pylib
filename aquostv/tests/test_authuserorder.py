...
class TestAuthUserOrder(MockerTestCase):
    @classmethod
    def setUpClass(cls):
        pass

    def setUp(self):
        self.order = order.AuthUserOrder(USER)
        self.mocker.replay()
    ...
    def test_receive(self, ):
        ...
        self.assertIsInstance(got, order.AuthUserReceiver)
...
# coding: utf-8
# End:
# test_authuserorder.py ends here
