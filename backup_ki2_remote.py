...
def backup():
    ...
    @Return:
    """
    # if RUNLEVEL != RunLevel().get_current_level():
    #     return False
...
def getoptions():
    """Option function."""
    parser = argparse.ArgumentParser(description="""Backup king2""")
