...
# $Id: test_vernalequinox.py 289 2015-01-29 00:17:20Z t1 $
# $Revision: 289 $
...
class TestCalcVernaleEuinox(MockerTestCase):
    @classmethod
    def setUpClass(cls):
...
# coding: utf-8
# End:
# test_vernalequinox.py ends here
