...
# $Id: test_ungrabkeyboard.py 342 2015-07-24 05:07:32Z t1 $
# $Revision: 342 $
...
from xcb2.xproto.ext import UngrabKeyboard, UngrabKeyboardChecked


class TestUngrabKeyboardBinary(MockerTestCase):
    @classmethod
    def setUpClass(cls):
        cls.args1 = [(0, ), '\x00\x00\x00\x00\x00\x00\x00\x00']
        cls.args2 = [(1, ), '\x00\x00\x00\x00\x01\x00\x00\x00']
        cls.args3 = [(2, ), '\x00\x00\x00\x00\x02\x00\x00\x00']
        cls.conn = xcb.connect()
        cls.protocol = UngrabKeyboard(cls.conn)
        cls.protocol_check = UngrabKeyboardChecked(cls.conn)
...
class TestUngrabKeyboardRequest(MockerTestCase):
    @classmethod
    def setUpClass(cls):
        cls.argsbin = [(0, ), '\x00\x00\x00\x00\x00\x00\x00\x00']
        cls.conn = xcb.connect()
        cls.protocol = UngrabKeyboard(cls.conn)
        cls.protocol_check = UngrabKeyboardChecked(cls.conn)
    ...
    def test_call(self):
        r"""Test UngrabKeyboard.__call__() expect return VoidCookie."""
    ...
    def test_request(self, ):
        r"""Test UngrabKeyboard.request() expect return VoidCookie."""
...
# coding: utf-8
# End:
# test_ungrabkeyboard.py ends here
